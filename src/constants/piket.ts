...
export const STATUS_OPTIONS: OptionStatus[] = [
  ...
  { value: 'sakit_tugas', label: 'Sakit + Memberi Tugas', badgeClass: 'bg-amber-500/10 text-amber-400 border-amber-500/30' },
  { value: 'sakit_tanpa_tugas', label: 'Sakit (Tanpa Tugas)', badgeClass: 'bg-amber-600/10 text-amber-500 border-amber-600/30' },
  { value: 'dinas_tugas', label: 'Dinas + Memberi Tugas', badgeClass: 'bg-blue-500/10 text-blue-400 border-blue-500/30' },
  { value: 'dinas_tanpa_tugas', label: 'Dinas (Tanpa Tugas)', badgeClass: 'bg-blue-600/10 text-blue-500 border-blue-600/30' },
  { value: 'izin_tugas', label: 'Izin + Memberi Tugas', badgeClass: 'bg-sky-500/10 text-sky-400 border-sky-500/30' },
